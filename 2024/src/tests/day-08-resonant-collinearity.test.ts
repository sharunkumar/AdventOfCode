import { default as part1 } from "#/solutions/day-08-resonant-collinearity-1";
import { default as part2 } from "#/solutions/day-08-resonant-collinearity-2";
import { readFileSync } from "node:fs";
import { describe, test, beforeAll, expect } from "bun:test";

describe("Day 08: Resonant Collinearity", () => {
  let input_1: string;
  ...
  test("part 1", async () => {
    ...
    expect(output).toBe(14); // FIXME - part 1
  });
