import { default as part1 } from "#/solutions/day-02-rednosed-reports-1";
import { default as part2 } from "#/solutions/day-02-rednosed-reports-2";
import { readFileSync } from "node:fs";
import { describe, test, beforeAll, expect } from "bun:test";

describe("Day 02: RedNosed Reports", () => {
  let input_1: string;
