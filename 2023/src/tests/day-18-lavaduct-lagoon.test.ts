import { default as part1 } from "../solutions/day-18-lavaduct-lagoon-1"
import { default as part2 } from "../solutions/day-18-lavaduct-lagoon-2"
...
describe("Day 18: Lavaduct Lagoon", () => {
  ...
  test("part 2 - prod", async () => {
    ...
    expect(output).toBe(59574883048274)
  })
})
